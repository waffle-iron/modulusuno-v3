 ...
 */
@TestFor(GroupNotifycationService)
@Mock([NotificationGroup])
class GroupNotifycationServiceSpec extends Specification {
    ...
    def "Create a new notification group"() {
      ...
      when:"we want to save the group"
        def firstUserNotificationGroup = service.createNotificationGroup(notificationId, userList)
      then:"we should get"
    ...
    def "Update a notification group"() {
      ...
      and:"A first notificationGroup"
        def firstNotificationGroup = new NotificationGroup(emailerId:"586d4944e1d4ae54524dd622", users:userList).save()
      ...
      when:"we want to update the group"
        service.updateNotificationGroupUsers(groupId, newUsersList)
        service.updateNotifyIdNotificationGroup(groupId, notificationId)
