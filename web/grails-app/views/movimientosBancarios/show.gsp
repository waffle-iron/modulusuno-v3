...
<html>
    ...
    <body>
        <div id="show-movimientosBancarios" class="content scaffold-show" role="main">
          <h1><g:message code="default.show.label" args="[entityName]" /> ${bankAccount} <p> Saldo Total: <modulusuno:amountAccountToday id="${bankAccount.id}" /></p></h1>
          <p><g:link controller="movimientosBancarios" action="create" class="btn btn-green" id="${bankAccount.id}"><i class="fa fa-plus" aria-hidden="true"></i> Agregar nuevo movimiento</g:link></p>
