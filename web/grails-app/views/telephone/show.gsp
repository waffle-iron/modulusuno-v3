...
<html>
    ...
    <body>
        ...
        <div id="show-telephone" class="content scaffold-show" role="main">
            ...
            <f:display bean="telephone" />
            <g:form resource="${this.telephone}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.telephone}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
